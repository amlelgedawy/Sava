...
# Allow running this script directly (not as package)
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from data_preprocessing.convert_to_ntu import mediapipe_to_ntu
...
def main():
    ...
    while True:
        ...
        if len(window) == WINDOW_SIZE:
            ...
            pred_id, conf, _ = predict(model, device, window_np)
